...
const SkillCard = ({ skill, index }) => {
  ...
  return (
    <motion.div
      ...
      id={`skill-card-${skill.name.replace(/[^a-z0-9]/gi, '-').toLowerCase()}`}
    >
      {/* Border glow */}
      <div className="sk-card-border" style={{ '--sk-color': skill.color }} />

      {/* Spotlight */}
      <div className="sk-card-glow" style={{ '--sk-color': skill.color, opacity: hovered ? 1 : 0 }} />
