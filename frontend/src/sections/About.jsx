...
/* ─── Stats ──────────────────────────────────────────────────── */
const STATS = [
  { icon: '🏆', num: 5, suffix: '+', label: 'Projects Built' },
      ...
      <div className="ab-inner">
        ...
        >
          ...
          <div className="ab-bio">
            {[
              <>
                I'm a developer from India, currently pursuing my B.Tech in Computer Science and <em className="ab-em">AIML</em> at ABES Engineering College. I enjoy building clean, <em className="ab-em">high-performance</em> web applications and exploring the evolving space of <em className="ab-em">Artificial Intelligence</em>.
              </>,
              <>
                I like turning complex problems into simple and intuitive solutions. I've worked on projects like <em className="ab-em">Mentor Map</em> and <em className="ab-em">MediFlow-AI</em>, where I focused on solving real-world challenges. Winning the <em className="ab-em">Smart India Hackathon 2024</em> was a big milestone that taught me how to build impactful solutions under pressure and in a team.
              </>,
              <>
                Outside of coding, I enjoy sketching UI ideas, experimenting with new frameworks, and participating in hackathons—it's where I really push myself and grow the most, especially when working under <em className="ab-em">pressure</em>.
              </>,
            ].map((para, i) => (
              <motion.p
                key={i}
          ...
          <div className="ab-ctas">
            ...
            <div className="ab-socials">
              {[
                ...
                { href: 'https://www.linkedin.com/in/nandini-goel-', title: 'LinkedIn', svg: <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" fill="currentColor" /> },
                { href: 'mailto:nandinigoel.0207@gmail.com', title: 'Email', svg: <><rect x="2" y="4" width="20" height="16" rx="2" stroke="currentColor" strokeWidth="2" fill="none" /><path d="M2 7l10 7 10-7" stroke="currentColor" strokeWidth="2" /></> },
              ].map((s, i) => (
                <motion.a
                  key={i}
                  href={s.href}
